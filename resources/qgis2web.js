...
map.getView().fit([3265535.724377, -408328.637054, 3440851.957578, -324024.788119], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">SITES DU PASEREC</h2>';
        return titleElement;
    })(),
